...
@property (nonatomic, assign) id <MosaicViewDatasourceProtocol> datasource;
@property (nonatomic, assign) id <MosaicViewDelegateProtocol> delegate;
@property (nonatomic, retain) MosaicDataView *selectedDataView;
